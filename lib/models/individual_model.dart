...
class PokemonIndModel {
    ...
    factory PokemonIndModel.fromRawJson(String str) => PokemonIndModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory PokemonIndModel.fromJson(Map<String, dynamic> json) => PokemonIndModel(
